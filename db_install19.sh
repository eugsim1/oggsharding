...
sudo bash -c `echo "=======================================================" 2&>1 /home/oracle/ansible.log`
sudo bash -c  `echo $server` 2&>>1 /home/oracle/ansible.log`
sudo bash -c  `echo "start script"` 2&>>1 /home/oracle/ansible.log`
